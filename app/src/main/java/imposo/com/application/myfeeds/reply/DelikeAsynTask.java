package imposo.com.application.myfeeds.reply;
 ...
 */
public class DelikeAsynTask extends AsyncTask<Void, Void, Void> implements NetworkConstants {
    ...
    public DelikeAsynTask(Context context, ReplyDTO replyDTO, int likes){
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            HttpPost httpPost = new HttpPost(GET_NETWORK_IP + DELIKE_COMMENT_REPLY);

...
public class LikeAsynTask extends AsyncTask<Void, Void, Void> implements NetworkConstants {
    ...
    public LikeAsynTask(Context context, CommentDTO commentDTO, int likes){
    ...
    protected Void doInBackground(Void... params) {
       ...
       // list.add(new BasicNameValuePair("postid", commentDTO.getCom+""));

        try {
            HttpClient httpClient = new DefaultHttpClient();
            HttpPost httpPost = new HttpPost(GET_NETWORK_IP + LIKE_COMMENT);
